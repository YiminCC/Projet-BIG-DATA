...
public class Marketing {
    ...
    private final String pathToCSVFile = "/home/vagrant/Projet_Big_Data/Marketing.csv";
    ...
    public static void main(String args[]) {
        try {
            Marketing mark = new Marketing(args);
    ...
    **/
    public void initMarketingTablesAndData(Marketing mark) {
